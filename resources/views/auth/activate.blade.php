    ...
    <div class="row justify-content-center">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">{{ __('Account Activation') }}</div>
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('activate.activate') }}" aria-label="{{ __('Activate Account') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group row {{ $errors->has('uid') ? ' has-error' : '' }}">
                            <label for="uid" class="col-md-4 col-form-label text-md-right control-label">{{ __('E-mail address') }}</label>

                            <div class="col-md-6">
                                <input id="uid" type="text" class="form-control" name="uid" value="{{ $uid ?? old('uid') }}" required autofocus>
